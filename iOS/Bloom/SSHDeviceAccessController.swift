...
final class SSHDeviceAccessController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        ["A key for this device", "Authorise it on your server", "If you lose this device"][section]
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case (0, 0):
            content.text = "Generated by Bloom"
            content.secondaryText = "Each device has its own SSH key. You do not need to import your Mac’s private key."
            content.image = UIImage(systemName: "key")
        case (0, 1):
            content.text = "The private key stays here"
            content.secondaryText = "It is stored in this device’s Keychain, available while unlocked, and does not sync through iCloud Keychain. Only the public key is shared."
