...
public struct ToolResultSummary: Sendable, Hashable {
    ...
    public static func decode(_ payload: Data, toolUseID: String? = nil) -> ToolResultSummary {
        ...
        let results = content.filter {
            (($0["type"] as? String) ?? "tool_result") == "tool_result"
                && (toolUseID == nil || $0["tool_use_id"] as? String == toolUseID)
        }
