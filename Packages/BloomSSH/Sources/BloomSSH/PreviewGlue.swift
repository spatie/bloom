...
// Adapted from SwiftNIO SSH 0.15.0 Sources/NIOSSHClient/GlueHandler.swift.
import NIOCore

final class PreviewGlue {
    private var partner: PreviewGlue?
...
extension PreviewGlue {
    static func matchedPair() -> (PreviewGlue, PreviewGlue) {
        let first = PreviewGlue()
        let second = PreviewGlue()
...
extension PreviewGlue: ChannelDuplexHandler {
