...
- `bloom-v13.schema.json`: JSON Schema draft 2020-12 for envelopes, all method/action names and portable payloads.
...
- `vectors-v13.json`: checked-in output from production Swift encoding, with synthetic identifiers/data.
