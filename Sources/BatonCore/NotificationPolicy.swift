...
///
/// Two facts, because two is all it takes: whether Baton is the app in front of the user, and
...
/// preference when somebody reports that Baton went quiet.
...
public enum NotificationPolicy {
    public static func verdict(
        ...
        // while Baton is the active app, and those are exactly the ones worth saying something
        // about.
