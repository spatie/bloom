...
enum ServerSidebar {
    static func project(_ action: ServerProjectAction, id: RepoID, store: Store) async throws {
        guard try await store.repo(id: id) != nil else { throw ServerFailure("This project is no longer available.") }
        switch action {
