...
/// The wording Baton sends to a coding agent when a button in the app stands in for a sentence the
...
struct PromptSettingsView: View {
    var body: some View {
        Form {
            Section {
                Text("""
                Some buttons in Baton do their work by asking the workspace's agent, rather than \
                running the command themselves. The agent already knows this project's commit \
                conventions and its pull request template, which Baton does not. These are the \
