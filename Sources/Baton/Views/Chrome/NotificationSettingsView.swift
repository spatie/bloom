...
/// behind Baton's back, and one row per event. Folded into General it would more than double that
...
struct NotificationSettingsView: View {
    ...
    var body: some View {
        Form {
            Section {
                ...
                Text("Nothing is sent for the workspace already on screen while Baton is in front of you.")
                    .font(Typo.caption)
        ...
        // Revoking the permission happens in System Settings, which means it happens while Baton is
        // in the background. Coming back is the only moment Baton gets to notice.
    ...
    private var blockedNotice: some View {
        LabeledContent {
            ...
            Label("macOS is blocking Baton's notifications", systemImage: "bell.slash.fill")
                .font(Typo.label)
