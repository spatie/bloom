...
/// size setting cannot be an environment value SwiftUI already honours; it has to be one Baton
/// resolves for itself.
///
...
struct ScaledFont: Hashable, Sendable {
    ...
    /// size. An unscaled Baton therefore renders exactly what it rendered before this existed:
