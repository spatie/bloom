...
/// it: not decoration, but the two things that actually make Bloom worth having (a second agent
        ...
        VStack(alignment: .leading, spacing: Metrics.inset) {
            ...
            LazyVGrid(columns: Self.columns, alignment: .leading, spacing: Metrics.gutter) {
                ...
                tile(
                    ...
                    message: "Bloom works in any git repository on this Mac, and Home keeps them all on one screen.",
