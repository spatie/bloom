...
- [`docs/SERVER.md`](docs/SERVER.md) covers the standalone server preview and connecting from the Mac app, which is off until Remote servers is turned on in Settings > General.
