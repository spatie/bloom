...
func writeInfo(writer http.ResponseWriter, config Config) {
	...
	json.NewEncoder(writer).Encode(map[string]any{"serverID": config.ServerID, "protocolVersion": 10, "authentication": "oauth2", "capabilities": []string{"rpc", "private-previews"}})
}
