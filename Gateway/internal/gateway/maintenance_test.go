...
func TestMaintenancePreservesIntentBehindControlAuthentication(t *testing.T) {
	...
	body := `{"version":16,"id":"00000000-0000-4000-8000-000000000001","operation":{"maintenance":{"_0":{"action":"start","credential":"fixture-maintenance-key","planID":"reviewed-plan","mode":"whenIdle"}}}}`
