...
func TestRPCRequiresAuthenticationBeforeConnectingAndPreservesIDs(t *testing.T) {
	...
	count := runtimeFixture(t, f, func(connection net.Conn, request rpcRequest) {
		json.NewEncoder(connection).Encode(map[string]any{"version": 11, "id": request.ID, "result": map[string]any{"hello": map[string]string{"name": "test"}}})
	})
	body := `{"version":11,"id":"00000000-0000-0000-0000-000000000001","operation":{"hello":{}}}`
...
func TestRPCRejectsMalformedAndOversizedBodies(t *testing.T) {
	...
	for _, body := range []string{
		...
		`{"version":11,"id":"00000000-0000-0000-0000-000000000001","operation":{"hello":{},"catalogue":{}}}`,
		`{"version":11,"id":"00000000-0000-0000-0000-000000000001","operation":{"hello":{}}}{"extra":true}`,
	} {
...
func TestTerminalStreamRequiresControlAccessAndRelaysBinaryInput(t *testing.T) {
	...
	count := runtimeFixture(t, f, func(connection net.Conn, request rpcRequest) {
		...
		json.NewEncoder(connection).Encode(map[string]any{"version": 11, "id": request.ID, "result": map[string]any{"text": map[string]string{"_0": path}}})
	})
