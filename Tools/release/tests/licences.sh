...
mkdir -p "$fixture/checkouts/swift-markdown-engine" "$fixture/checkouts/AppAuth-iOS"
...
cp LICENSE.md "$fixture/checkouts/AppAuth-iOS/LICENSE"
zsh Tools/package-licences.sh "$fixture/Bloom.app" "$fixture/checkouts"
for notice in Bloom SwiftTerm Sparkle SwiftArgumentParser Flare PLCrashReporter MarkdownEngine AppAuth; do
