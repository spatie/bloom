...
def sheet(outdir):
    ...
    html = ("<!doctype html><meta charset=utf-8><title>Bloom icon, ten depth "
            ...
            "one. The two strips under it are ACTUAL SIZE at 512, 256, 128, 64, "
            "32 and 16, from the same framed artwork at every size, which is "
            "what the layered document really does. The shipped "
