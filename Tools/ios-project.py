...
add('ROOT', 'isa = PBXProject; attributes = { LastUpgradeCheck = 2650; }; buildConfigurationList = PROJECTCONFIG; compatibilityVersion = "Xcode 16.0"; developmentRegion = en; knownRegions = (en, Base); mainGroup = GROUP; productRefGroup = PRODUCTS; projectDirPath = ""; projectRoot = ""; targets = (APP); packageReferences = (CLIENT, AUTH, SSH, UI, APPAUTH, SWIFTTERM);')
...
add('FRAMEWORKS', 'isa = PBXFrameworksBuildPhase; buildActionMask = 2147483647; files = (CLIENTBUILD, AUTHBUILD, SSHBUILD, UIBUILD, APPAUTHBUILD, SWIFTTERMBUILD); runOnlyForDeploymentPostprocessing = 0;')
...
add('SWIFTTERM', 'isa = XCRemoteSwiftPackageReference; repositoryURL = "https://github.com/migueldeicaza/SwiftTerm"; requirement = { kind = exactVersion; version = 1.19.0; };')
add('SWIFTTERMPRODUCT', 'isa = XCSwiftPackageProductDependency; package = SWIFTTERM; productName = SwiftTerm;')
add('SWIFTTERMBUILD', 'isa = PBXBuildFile; productRef = SWIFTTERMPRODUCT;')
...
for name in ['Debug', 'Release']:
    ...
    settings = f'''SKIP_INSTALL = NO;
PRODUCT_BUNDLE_IDENTIFIER = be.spatie.bloom.ios;
