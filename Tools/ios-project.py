...
add('ROOT', 'isa = PBXProject; attributes = { LastUpgradeCheck = 2650; }; buildConfigurationList = PROJECTCONFIG; compatibilityVersion = "Xcode 16.0"; developmentRegion = en; knownRegions = (en, Base); mainGroup = GROUP; productRefGroup = PRODUCTS; projectDirPath = ""; projectRoot = ""; targets = (APP); packageReferences = (CLIENT, AUTH, APPAUTH);')
...
add('APP', 'isa = PBXNativeTarget; buildConfigurationList = APPCONFIG; buildPhases = (SOURCES, FRAMEWORKS); buildRules = (); dependencies = (); name = Bloom; productName = Bloom; productReference = PRODUCT; productType = "com.apple.product-type.application"; packageProductDependencies = (CLIENTPRODUCT, AUTHPRODUCT, APPAUTHPRODUCT);')
...
add('FRAMEWORKS', 'isa = PBXFrameworksBuildPhase; buildActionMask = 2147483647; files = (CLIENTBUILD, AUTHBUILD, APPAUTHBUILD); runOnlyForDeploymentPostprocessing = 0;')
for key, name in [('CLIENT', 'BloomClient'), ('AUTH', 'BloomAuthentication')]:
...
for name in ['Debug', 'Release']:
    ...
    PRODUCT_NAME = Bloom; TARGETED_DEVICE_FAMILY = "1,2";
